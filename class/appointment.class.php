        ...
        function getAppointmentInfo($customer_id, $appointment_id){
            if($customer_id !== 'admin'){
                $sql = 'SELECT service.image, service.name, service.price, 
                        DATE_FORMAT(STR_TO_SETDATE(appointment_service.set_date, "%Y-%m-%d %H:%i:%s"),"%h:%i %p | %a | %M %d, %Y") AS setdate, appointment.status, appointment_service.address, appointment_service.specreq, appointment_service.contact_num 
                ...
                $sql = 'SELECT service.image, service.name, service.price, 
                        DATE_FORMAT(STR_TO_SETDATE(appointment_service.set_date, "%Y-%m-%d %H:%i:%s"),"%h:%i %p | %a | %M %d, %Y") AS setdate, appointment.status, appointment_service.address, appointment_service.specreq, appointment_service.contact_num, customer.first_name, 
