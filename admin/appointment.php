...
<?php
    ...
    ?>
        ...
        <div class="orders">
            ...
            ?>
                    <a href="<?php if($appointment_status['status'] === 'pending'){ echo 'checkout.php?appointment_id=' . $appointment_id; } else { echo 'appointment-info.php?appointment_id=' . $appointment_id; } ?>">
