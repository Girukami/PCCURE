...
<header class="w3-container header w3-center" style="padding:128px 16px; background-image: url(../MainBG.jpg); background-size: cover; background-position: center;">
  ...
  <a href="login.php" style="color:#425A9E"><button class="w3-button w3-white w3-padding-large w3-large w3-margin-top" style="border-radius: 50px;"><b>GET STARTED</b></button></a>
</header>
